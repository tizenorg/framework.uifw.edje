...
/**
+ * Check if (x,y) is on top of selected-text
+ * returns True if (x,y) is on top of selected-text.
+ *
+ * @param obj An Edje object.
+ * @param part The part containing the object.
+ * @param x X Coordinate.
+ * @param y Y Coordinate.
+ * @return True if (x,y) is on top of selected-text.
+ */
EAPI Eina_Bool
...
// TIZEN ONLY - END
/**
 * @brief Retrieves the number of lines occupied by the selection
 *
 * @param obj A valid Evas_Object handle
 * @param part The part name
...
/**
 * @brief Retrieves the current position of the given selection line
 *
 * @param obj A valid Evas_Object handle
 * @param part The part name
 * @param x A pointer to a variable where to insert the line's x
 * coordinate
 * @param y A pointer to a variable where to insert the line's y
 * coordinate
 * @param w A pointer to a variable where to insert the line's width
 * @param h A pointer to a variable where to insert the line's height
...
/**
  * @brief Get geometry of cursor handler.
  *
  * @param object A valid object handle
  * @param part edje part
  * @param x A pointer to a variable where to se the handler's x
  * @param y A pointer to a variable where to se the handler's y
  * @param w A pointer to a variable where to se the handler's width
  * @param h A pointer to a variable where to se the handler's height
  * @return EINA_TRUE if cursor handler is valid (existed and visible), otherwise EINA_FALSE
  */
 ...
 */
   ...
   // TIZEN_ONLY(20130830): For cursor movement when mouse up.i
