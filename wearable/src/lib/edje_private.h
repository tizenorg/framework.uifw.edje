...
// TIZEN ONLY ------------------------------------------------
void _edje_styles_cache_init();
void _edje_styles_cache_shutdown();
void _edje_styles_cache_clean();
Eina_Hash *_edje_styles_cache_find(const char *key);
void _edje_styles_cache_del(const char *key);
void _edje_styles_cache_add(const char *key, Eina_Hash *styles);
// -----------------------------------------------------------
