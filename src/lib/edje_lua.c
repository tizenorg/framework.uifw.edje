...
_edje_lua_open(lua_State *L)
{
   ...
   _edje_lua_new_const(L, "TEXT_EFFECT_TIZEN_GLOW_SHADOW", EDJE_TEXT_EFFECT_TIZEN_GLOW_SHADOW);
   _edje_lua_new_const(L, "TEXT_EFFECT_TIZEN_SOFT_GLOW_SHADOW", EDJE_TEXT_EFFECT_TIZEN_SOFT_GLOW_SHADOW);
   _edje_lua_new_const(L, "TEXT_EFFECT_TIZEN_GLOW", EDJE_TEXT_EFFECT_TIZEN_GLOW);
   /////
