                 ...
                 Evas_Coord sw, Evas_Coord sh, int *free_text)
{
   ...
   *free_text = 0;
   ...
   evas_object_resize(ep->object, sw, sh);
			...
			Edje_Part_Description_Text *chosen_desc)
{
   ...
   if (!chosen_desc->text.min_x)
	...
	text = _edje_text_fit_x(ed, ep, params, text, font, size, sw, sh, &free_text);
     }
   ...
   EINA_LIST_FOREACH(prev_sources, li, source_name)
     evas_object_text_filter_source_set(ep->object, source_name, NULL);
   EINA_LIST_FOREACH(filter_sources, li, source_name)
     {
        Edje_Real_Part *rp = _edje_real_part_get(ed, source_name);
        evas_object_text_filter_source_set(ep->object, source_name,
                                           rp ? rp->object : NULL);
     }
   evas_object_text_filter_program_set(ep->object, filter);
        ...
        switch (effect & EDJE_TEXT_EFFECT_MASK_BASIC)
	     ...
	     evas_object_text_glow2_color_set(ep->object,
           ...
           case EDJE_TEXT_EFFECT_TIZEN_GLOW_SHADOW:
             style = EVAS_TEXT_STYLE_TIZEN_GLOW_SHADOW;
             evas_object_text_glow_color_set(ep->object,
                                             (params->type.text.color2.r * params->type.text.color2.a) / 255,
                                             (params->type.text.color2.g * params->type.text.color2.a) / 255,
                                             (params->type.text.color2.b * params->type.text.color2.a) / 255,
           ...
           case EDJE_TEXT_EFFECT_TIZEN_SOFT_GLOW_SHADOW:
             style = EVAS_TEXT_STYLE_TIZEN_SOFT_GLOW_SHADOW;
             evas_object_text_glow_color_set(ep->object,
                                             (params->type.text.color2.r * params->type.text.color2.a) / 255,
                                             (params->type.text.color2.g * params->type.text.color2.a) / 255,
                                             (params->type.text.color2.b * params->type.text.color2.a) / 255,
           ...
           case EDJE_TEXT_EFFECT_TIZEN_SHADOW:
             style = EVAS_TEXT_STYLE_TIZEN_SHADOW;
             evas_object_text_shadow_color_set(ep->object,
                                               (params->type.text.color3.r * params->type.text.color3.a) / 255,
                                               (params->type.text.color3.g * params->type.text.color3.a) / 255,
                                               (params->type.text.color3.b * params->type.text.color3.a) / 255,
